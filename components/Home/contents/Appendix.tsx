  ...
  return (
    <ViewDetect id='appendix'>
      <div className={styles.section}>
        ...
        <div className={styles.inside_section} id='error_codes_reference'>
        ...
        <div className={styles.inside_section} id='provider_game_types'>
        ...
        <div className={styles.inside_section} id='pagination'>
        ...
        <div className={styles.inside_section} id='language'>
        ...
        <div className={styles.inside_section} id='date_time_input_output'>
        ...
        <div className={styles.inside_section} id='supported_timezone'>
        ...
        <div className={styles.inside_section} id='mimi_seamless_diagram'>
